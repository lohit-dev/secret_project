...
```shell
SRC_CHAIN_RPC=http://localhost:8550 DST_CHAIN_RPC=wss://bsc-rpc.publicnode.com bun run test
``` 
...
<!-- monad to etherlink -->
SRC_CHAIN_RPC=https://rpc.ankr.com/monad_testnet DST_CHAIN_RPC=https://rpc.ankr.com/etherlink_testnet pnpm test
