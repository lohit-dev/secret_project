...
describe('Resolving example', () => {
    ...
    describe('Fill', () => {
        it('should swap Ethereum USDC -> Bsc USDC. Single fill only', async () => {
            ...
            console.log(`   3️⃣ ✅ Source Deploy Block Hash: ${srcDeployBlock}`);
            console.log(`   4️⃣ ✅ Source Withdrawal Transaction - Hash: ${resolverWithdrawHash}`);
...
// green nothing click laugh smoke beef bean hurt game multiply good educate